...
foreach ($needle in @("showPreSleepCheck", "heartbeatText", "testGentleReminder", "preSleepStatusText", "requestIgnoreBatteryOptimization", "batteryOptimizationText", "guardIntegrityScore", "detectionConfidenceText", "showDetectionTest", "simulateEvent", "showMorningCare", "showMedicationDialog", "scheduleMedicationReminder", "showCompanionSettings", "addCompanionChoice", "showOwnerProfileSettings", "showOwnerProfileDialog", "showOwnerProfileWizard", "saveOwnerProfileWizardStep", "saveOwnerProfileField", "showAssistantPersonaDialog", "saveAssistantPersonaFromMessage", "extractAssistantName", "proactiveCareText", "maybeShowProactiveCare", "startAssistantMotion", "showDeepSeekSettings", "showDeepSeekQuestionDialog", "askDeepSeek", "looksLikeFindObjectQuestion", "addAiQuestionButton", "deepSeekSystemPrompt", "deepSeekUserPrompt", "showCompanionChat", "addRealtimeVoicePanel", "startRealtimeVoiceChat", "SpeechRecognizer", "RecognizerIntent", "handleRealtimeVoiceText", "showCompanionVoiceReply", "stopAssistantSpeech", "showCompanionReply", "showCompanionWaiting", "showCompanionVision", "requestCameraForVision", "handleVisionSnapshot", "askDeepSeekVision", "maybeStartAutoVisionScan", "startAutoVisionCapture", "deepSeekAutoVisionPrompt", "storeAutoVisionMemory", "bitmapToLimitedJpeg", "VISION_MAX_JPEG_BYTES", "CameraDevice.TEMPLATE_STILL_CAPTURE", "bitmapToJpegBase64", "decodeVisionBitmap", "MediaStore.EXTRA_OUTPUT", "showObjectMemoryDialog", "showFindObjectDialog", "addAssistantHero", "roleAvatarAssetName", "speakAssistantText", "assistantOnlineEnabled", "ownerProfileSummary", "assistantProactiveCareEnabled", "assistantAutoVisionEnabled", "assistantPersonaSummary", "onNewIntent", "shouldOpenMorningCare", "showEvidenceSettings", "showDeviceReadingDialog", "deviceReadingsText", "createDemoEvidenceClip", "showEventReviewDialog", "playEvidenceAudio", "signalBaselineSamples", "signalAudioBaselineRms", "signalMotionBaseline", "safeTopPadding", "statusBarHeight", "setEmergencyContacts", "MAX_EMERGENCY_CONTACTS", "emergencyActionSummary", "keySaved", "showAssistantCheckIn", "saveAssistantCheckIn", "showAssistantCheckInDialog", "assistantCheckInSummary")) {
...
foreach ($needle in @("MAX_EMERGENCY_CONTACTS", "emergencyPhone(int index)", "emergencyPhones", "setEmergencyContacts", "emergencySummary", "emergencyActionSummary", "cleanEmergencyPhone", "emergencyPhoneValidationError", "assistantCheckInToday", "setAssistantCheckIn", "assistantCheckInSummary", "assistantPersonaConfigured", "setAssistantPersona", "assistantPersonaSummary", "assistantAutoVisionEnabled", "markAssistantAutoVisionNow", "setVisualMemory", "visualMemorySummary", "markMedicationSeen", "medicationVisionSummary", "AndroidKeyStore", "deepseek_api_key_encrypted_v1", "encryptSecret", "decryptSecret", "GCMParameterSpec", "remove(LEGACY_DEEPSEEK_API_KEY)")) {
...
foreach ($needle in @("audio_path", "audio_summary", "motion_summary", "device_summary", "evidence_level", "doctorReportText", "device_readings", "insertDeviceReading", "nearestDeviceEvidence", "findNearestDeviceReading", "object_memory", "upsertObjectMemory", "objectMemoryAnswer", "objectMemorySummary", "clearObjectMemory")) {
...
foreach ($needle in @("MedicationReminderReceiver", "VisionImageProvider", "grantUriPermissions", "SCHEDULE_EXACT_ALARM", "android.permission.CAMERA", "android:debuggable=`"true`"")) {
