...
foreach ($needle in @("ROLE_SISTER", "ROLE_BROTHER", "ROLE_YOUNG_MAN", "ROLE_GENTLE_WOMAN", "chatSleepReport", "chatPrivacy", "sampleLine", "checkInIntro", "checkInReply", "checkInCareLine")) {
